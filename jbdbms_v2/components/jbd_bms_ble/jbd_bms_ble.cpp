// Based on https://github.com/syssi/esphome-jbd-bms (Apache License 2.0)
// Modified: increased MAX_RESPONSE_SIZE to 128 and fixed frame assembly guard
// to prevent premature end-of-frame detection when a data byte matches JBD_PKT_END.
